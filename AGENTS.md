# AGENTS.md — cod-demo-reader

Repository `cod-demo-reader` in the frasermolyneux organization. Adapt this brief with repo-specific scope and validation commands.
